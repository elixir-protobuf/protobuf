...
defmodule Protobuf.Protoc.IntegrationTest do
  ...
  test "encode and decode My.Test.Request" do
    entry = %My.Test.Reply.Entry{key_that_needs_1234camel_CasIng: 1, value: -12345, _my_field_name_2: 21}
    reply = %My.Test.Reply{found: [entry], compact_keys: [1, 2, 3]}
    input = My.Test.Request.new(
      key: [123], hue: My.Test.Request.Color.value(:GREEN), hat: My.Test.HatType.value(:FEZ),
  ...
  test "encode and decode My.Test.Communique(oneof)" do
    unions = [number: 42, name: "abc", temp_c: 1.2, height: 2.5, today: 1, maybe: true,
              delta: 123, msg: My.Test.Reply.new()]
