defmodule Protobuf.Protoc.Generator.MessageTest do
  ...
  test "generate/2 has right name" do
    ...
    assert TestHelpers.get_type_spec_as_string(compiled_mod, bytecode, :t) ==
             "t() :: %Foo{__unknown_varints__: [{field_number :: integer(), value :: integer()}]}"
  after
  ...
  test "generate/2 has right fields for proto3" do
    ...
    assert TestHelpers.get_type_spec_as_string(compiled_mod, bytecode, :t) ==
             "t() :: %Foo{__unknown_varints__: [{field_number :: integer(), value :: integer()}], a: integer(), b: String.t(), c: [integer()]}"
  ...
  test "generete/2 supports message type field" do
    ...
    assert TestHelpers.get_type_spec_as_string(compiled_mod, bytecode, :t) ==
             "t() :: %Foo{__unknown_varints__: [{field_number :: integer(), value :: integer()}], bar: Bar.t() | nil, baz: [Baz.t()]}"
  after
    TestHelpers.purge_modules([Foo])
  end
  ...
  test "generate/2 supports map field" do
    ...
    assert TestHelpers.get_type_spec_as_string(compiled_mod, bytecode, :t) ==
             "t() :: %FooBar.AbCd.Foo{__unknown_varints__: [{field_number :: integer(), value :: integer()}], a: %{optional(integer()) => FooBar.AbCd.Bar.t() | nil}}"
  after
  ...
  test "generate/2 generate right message type name with different package" do
    ...
    assert TestHelpers.get_type_spec_as_string(compiled_mod, bytecode, :t) ==
             "t() :: %FooBar.AbCd.Foo{__unknown_varints__: [{field_number :: integer(), value :: integer()}], a: OtherPkg.MsgFoo.t() | nil}"
  after
    TestHelpers.purge_modules([FooBar.AbCd.Foo])
  end
  ...
  test "generate/2 supports nested messages with right defaults" do
    ...
    assert TestHelpers.get_type_spec_as_string(compiled_mod, bytecode, :t) ==
             "t() :: %MyPkg.Foo{__unknown_varints__: [{field_number :: integer(), value :: integer()}], a: MyPkg.Foo.Nested.t() | nil}"
  after
  ...
  test "generate/2 supports oneof" do
    ...
    assert TestHelpers.get_type_spec_as_string(compiled_mod, bytecode, :t) ==
             "t() :: %Foo{__unknown_varints__: [{field_number :: integer(), value :: integer()}], first: {:a, integer()} | {:b, integer()}, other: integer() | nil, second: {:c, integer()} | {:d, integer()}}"
  ...
  test "generate/2 repeated enum field" do
    ...
    assert TestHelpers.get_type_spec_as_string(compiled_mod, bytecode, :t) ==
             "t() :: %FooBar.AbCd.Foo{__unknown_varints__: [{field_number :: integer(), value :: integer()}], a: [FooBar.AbCd.EnumFoo.t()]}"
  after
    TestHelpers.purge_modules([FooBar.AbCd.Foo])
  end
end
