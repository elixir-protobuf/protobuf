defmodule Protobuf.DSLTest do
  ...
  defmodule Foo do
    ...
    field :e, 6, repeated: true, type: :int32, packed: true
  end
  ...
  test "supports repeated_fields" do
    msg_props = Foo.__message_props__
    assert msg_props.repeated_fields == [:c, :e]
  end

  test "supports packed option" do
    msg_props = Foo.__message_props__
    field_props = msg_props.field_props
    assert %Protobuf.FieldProps{fnum: 6, name: "e", repeated: true, packed: true} = field_props[6]
  end
end
