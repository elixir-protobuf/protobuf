defmodule Protobuf.ExtensionTest do
  ...
  test "extension persistent works" do
    ...
    assert TestMsg.Ext.PbExtension = GlobalStore.get({Protobuf.Extension, TestMsg.Ext.Foo1, :"Parent.foo"}, nil)
  end
  ...
  test "extension get/put work" do
    ...
    assert %{__pb_extensions__: %{"Parent.foo": "nested.foo"}} = TestMsg.Ext.Foo1.put_extension(%{}, :"Parent.foo", "nested.foo")
  end
