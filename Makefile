...
gen-protos: protoc-gen-elixir
	...
	protoc -I src -I test/protobuf/protoc/proto --elixir_out=custom_field_options=true,gen_descriptors=true:test/protobuf/protoc/proto_gen --plugin=./protoc-gen-elixir test/protobuf/protoc/proto/extension2.proto
