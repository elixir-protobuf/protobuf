defmodule Protobuf.Decoder do
  ...
  defp decode_field(<<0::1, x0::7, rest::bits>>, message, props, nesting) do
    dispatch_field(x0, rest, message, props, nesting)
  end

  defp decode_field(<<1::1, x0::7, 0::1, x1::7, rest::bits>>, message, props, nesting) do
    dispatch_field(x0 + bsl(x1, 7), rest, message, props, nesting)
  end
  ...
  defp decode_field(
    ...
    dispatch_field(x0 + bsl(x1, 7) + bsl(x2, 14), rest, message, props, nesting)
  end
  ...
  defp decode_field(
    ...
    dispatch_field(
      x0 + bsl(x1, 7) + bsl(x2, 14) + bsl(x3, 21),
      rest,
      message,
      props,
      nesting
  ...
  defp decode_field(<<_::bits>>, _message, _props, _nesting) do
    raise Protobuf.DecodeError, message: "cannot decode binary data: invalid field tag"
  end

  defp dispatch_field(tag, rest, message, props, nesting) do
  ...
  defp handle_value(<<rest::bits>>, field_number, wire_type, value, message, props, nesting) do
    case props.field_props do
      ...
      %{^field_number => %FieldProps{wire_type: ^wire_type} = prop} ->
        ...
        new_message =
          update_in_message(message, key, value, &value_for_field/4, prop, nesting)
  ...
  defp value_for_packed(
         bin,
         current,
         %FieldProps{type: type, wire_type: wire_type},
         _nesting
       )
